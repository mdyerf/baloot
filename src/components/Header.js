    ...
    <header className="header">
      ...
      {showSearch ? (
        <div className="header__search">
          <select value={searchOption} onChange={e => onSearchOptionChange(e.target.value)} className="header__search__options">
            <option value="name">name</option>
            <option value="price">price</option>
          </select>
          <Input value={searchValue} onChange={e => onQueryChange(e.target.value)} type="text" variant="contained" placeholder="search your product ..." />
